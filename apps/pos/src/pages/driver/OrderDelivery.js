...
function PickedUpButton({ orderId, onDone }) {
    ...
    return (_jsxs(_Fragment, { children: [err && _jsx("div", { className: "rounded-xl bg-red-50 px-4 py-3 text-sm text-red-700", children: err }), _jsx("button", { disabled: busy, onClick: handlePickedUp, className: "w-full rounded-2xl bg-teal-600 py-4 text-base font-bold text-white hover:bg-teal-700 disabled:opacity-60 transition-colors shadow-sm", children: busy ? "Processing…" : "📦 I've Picked Up" })] }));
}
